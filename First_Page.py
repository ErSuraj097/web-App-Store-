...
class slider():
    def __init__(self,root):
        ...
        self.txt_lbl=Label(self.root,text=" Web Application Store",font=("times new roman",30,"bold"),bg="whitesmoke",fg="navy").place(x=20,y=150,)
        ...
        self.img5=ImageTk.PhotoImage(file='image\suraj11.jpg')
