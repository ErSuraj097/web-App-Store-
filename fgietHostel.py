...
class Register :
    def __init__(self, root):
        ...
        self.title_lbl1=Label(self.root,text="       RAJIV GANDHI BOYS HOSTEL",font=("times new roman",40,"bold"),bg="khaki",fg="crimson").place(x=0,y=5,width=1100)
        self.title_lbl1=Label(self.root,text="          Feroze Gandhi Institute of Engineering & Technology",font=("times new roman",20,"bold"),bg="khaki",fg="crimson").place(x=200,y=60)
        ...
        title= Label(self.root,text="           BOYS HOSTEL STUDENT \nLOGIN ",font=("Impact",20,"bold"),bg="teal",fg="white").place(x=80,y=140)
        title2= Label(self.root,text="\t\t\tFGIET",font=("times new roman",10,"italic","bold"),bg="teal",fg="white").place(x=85,y=210)
        ...
        btn_reg=Button (frame1,text="Student Register Here",font=("times new roman",15),bg="red",fg="white",bd=0,cursor="hand2",command=self.reg_data).place(x=50,y=420,width=180)
